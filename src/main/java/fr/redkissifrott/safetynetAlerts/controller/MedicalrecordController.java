...
public class MedicalrecordController {
	...
	public ResponseEntity<Object> createMedicalrecord(@RequestBody Medicalrecord medicalrecord) {
		logger.info("Create request : POST http://localhost:8080/medicalrecord/ - Body :{}", medicalrecord);
		try {
	...
	public ResponseEntity<Medicalrecord> updateMedicalrecord(@PathVariable("firstName") final String firstName,
	...
	public ResponseEntity<Object> deleteMedicalrecord(@PathVariable("firstName") final String firstName,
