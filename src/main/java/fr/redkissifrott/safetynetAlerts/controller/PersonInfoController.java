...
public class PersonInfoController {
	...
	@ResponseBody
	public ResponseEntity<PersonInfoDto> getPersonInfoDto(@RequestParam("firstName") final String firstName,
			@RequestParam("lastName") final String lastName) {
		logger.info("Request : GET http://localhost:8080/personInfo?firstName={}&lastName={}", firstName, lastName);
		PersonInfoDto personMedicalrecord = personMedicalrecordService.getPersonInfo(firstName, lastName);
